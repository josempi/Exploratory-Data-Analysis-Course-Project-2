...
## Question: How have emissions from motor vehicles sources changed from 1999-2008 in Baltimore     ##
##           City?                                                                                  ##
##                                                                                                  ##
######################################################################################################
...
ggplot(data=NEIsummary, aes(x=NEIsummary$`NEIBaltimore$year`, y=NEIsummary$SPM2.5, color = Sample_Source)) + 
    ...
    ggtitle("Baltimore City, Maryland, PM2.5 Total Vehicle Emissions")
